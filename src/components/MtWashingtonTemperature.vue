    ...
    <main>
        ...
        <div class="wireframes">
            <figure class="wireframe">
                <img src="/images/wireframes/mt-washington-temperature1a.png" alt="wireframe drawing of page, without styling">
                <figcaption><strong>Wireframe 1A</strong> - Initial wireframe with text and placeholders for the decorative image and interactive chart.</figcaption>
            </figure>
            <figure class="wireframe">
                <img src="/images/wireframes/mt-washington-temperature1b.png" alt="wireframe drawing of page, with styling">
